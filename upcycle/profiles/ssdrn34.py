...
def place_ssdrn34_l16(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)

@ops.placement_profile(
    [OracleArch, BgroupArch],
    ops.Conv2D(None, None, None, 150, 150, 256, 150, 150, 256, 3, 3, 1, None, None))
def place_ssdrn34_l17(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)

@ops.placement_profile(
    [OracleArch, BgroupArch],
    ops.Conv2D(None, None, None, 150, 150, 256, 75, 75, 512, 3, 3, 2, None, None))
def place_ssdrn34_l30(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l36(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l37(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l38(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l39(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
def place_ssdrn34_l40(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l41(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l42(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l43(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l44(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l45(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
def place_ssdrn34_l46(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l47(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
def place_ssdrn34_l48(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
# def place_ssdrn34_l49(arch : Arch, conv : ops.Conv2D):
#     return ops.conv2d.place_conv_pq_spatial(arch, conv)
...
def place_ssdrn34_l50(arch : Arch, conv : ops.Conv2D):
    return ops.conv2d.place_conv_pq_spatial(arch, conv)
