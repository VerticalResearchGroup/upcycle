...
class MatmulTileKMKN_NT(MatmulTile):
    tr_a = True
    tr_b = False
...
@dataclass(frozen=True)
class MatmulTile256KMKNFP16_NT(MatmulTileKMKN_NT):
    vbits = 256
    dtype = Dtype.FP16
    tm = 16
    tn = 2
...
@dataclass(frozen=True)
class MatmulTile512KMKNFP16_NT(MatmulTileKMKN_NT):
    vbits = 512
    dtype = Dtype.FP16
    tm = 32
    tn = 2
...
@dataclass(frozen=True)
class MatmulTile1024KMKNFP16_NT(MatmulTileKMKN_NT):
    vbits = 1024
    dtype = Dtype.FP16
    tm = 64
    tn = 2
