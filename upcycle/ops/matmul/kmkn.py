...
class MatmulTileKMKN(MatmulTile):
    tr_a = True
    tr_b = False
    ttk = None
...
@dataclass(frozen=True)
class MatmulTile256KMKNFP16(MatmulTileKMKN):
    vbits = 256
    dtype = Dtype.FP16
    tm = 8
    tn = 2
...
@dataclass(frozen=True)
class MatmulTile512KMKNFP16(MatmulTileKMKN):
    vbits = 512
    dtype = Dtype.FP16
    tm = 16
    tn = 2
...
@dataclass(frozen=True)
class MatmulTile1024KMKNFP16(MatmulTileKMKN):
    vbits = 1024
    dtype = Dtype.FP16
    tm = 32
    tn = 2
