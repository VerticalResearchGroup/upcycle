...
def ssdrn34_300(dtype, n=1): assert False
    # return Trace([
    #     ops.Conv2D(dtype, True, n, 300, 300, 3, 150, 150, 64, 7, 7, 2, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 75, 75, 64, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 38, 38, 128, 3, 3, 2, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 75, 75, 64, 38, 38, 128, 1, 1, 2, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 128, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 128, 38, 38, 256, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    ...
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 256, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 19, 19, 512, 3, 3, 2, False),
    #     ops.Conv2D(dtype, True, n, 19, 19, 512, 19, 19, 256, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 19, 19, 256, 10, 10, 512, 3, 3, 2, False),
    #     ops.Conv2D(dtype, True, n, 10, 10, 512, 10, 10, 128, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 10, 10, 128, 5, 5, 256, 3, 3, 2, False),
    #     ops.Conv2D(dtype, True, n, 5, 5, 256, 5, 5, 128, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 5, 5, 128, 3, 3, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 3, 3, 256, 3, 3, 128, 1, 1, 1, False),
    #     ops.Conv2D(dtype, True, n, 3, 3, 128, 1, 1, 256, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 16, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 38, 38, 256, 38, 38, 324, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 19, 19, 512, 19, 19, 24, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 19, 19, 512, 19, 19, 486, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 10, 10, 512, 10, 10, 24, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 10, 10, 512, 10, 10, 486, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 5, 5, 256, 5, 5, 24, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 5, 5, 256, 5, 5, 486, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 3, 3, 256, 3, 3, 16, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 3, 3, 256, 3, 3, 324, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 1, 1, 256, 1, 1, 16, 3, 3, 1, False),
    #     ops.Conv2D(dtype, True, n, 1, 1, 256, 1, 1, 324, 3, 3, 1, False),
    # ])
