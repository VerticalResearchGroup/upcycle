...
def ssdrn34_300(dtype, n=1):
    return Trace([
        ops.Conv2D(dtype, 1, 300, 300, 3, 150, 150, 64, 7, 7, 2, 3, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 75, 75, 64, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 38, 38, 128, 3, 3, 2, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 75, 75, 64, 38, 38, 128, 1, 1, 2, 0, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 128, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 128, 38, 38, 256, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ...
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 3, 3, 1, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 38, 38, 256, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 19, 19, 512, 3, 3, 2, 1, False),
        ops.Conv2D(dtype, 1, 19, 19, 512, 19, 19, 256, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 19, 19, 256, 10, 10, 512, 3, 3, 2, 1, False),
        ops.Conv2D(dtype, 1, 10, 10, 512, 10, 10, 128, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 10, 10, 128, 5, 5, 256, 3, 3, 2, 1, False),
        ops.Conv2D(dtype, 1, 5, 5, 256, 5, 5, 128, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 5, 5, 128, 3, 3, 256, 3, 3, 1, 0, False),
        ops.Conv2D(dtype, 1, 3, 3, 256, 3, 3, 128, 1, 1, 1, 0, False),
        ops.Conv2D(dtype, 1, 3, 3, 128, 1, 1, 256, 3, 3, 1, 0, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 13, 13, 16, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 38, 38, 256, 13, 13, 324, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 19, 19, 512, 7, 7, 24, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 19, 19, 512, 7, 7, 486, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 10, 10, 512, 4, 4, 24, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 10, 10, 512, 4, 4, 486, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 5, 5, 256, 2, 2, 24, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 5, 5, 256, 2, 2, 486, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 3, 3, 256, 1, 1, 16, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 3, 3, 256, 1, 1, 324, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 1, 1, 256, 1, 1, 16, 3, 3, 3, 1, False),
        ops.Conv2D(dtype, 1, 1, 1, 256, 1, 1, 324, 3, 3, 3, 1, False),
    ])
